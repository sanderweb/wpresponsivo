...
/**************************************
 * Registro Custom Post type Slider (Criar Slider no menu WP)
 **************************************/
...
function servicos_registrer(){
    ...
    $args = array(
        ...
        'rewrite' => true,
        'has_archive' => true,
        'menu_icon' => 'dashicons-media-code',// PARA TROCAR OICONE MUDE AQUI
        //PARA PEGAR O ICONE PEGUE AQUI => https://developer.wordpress.org/resource/dashicons/#pressthis
        'capability_type' => 'post',
        'hierarchical' => false,
...
/**************************************
 * Registro de sidebar Cria Widget
 **************************************/
//COLAR ESSE PEDAÇO NA FUNCTIONS
...
<!--Essa linha embaixxo esta fora errada!-->
// <?php 
/**************************************
 * Breadcrumbs 
 **************************************/
